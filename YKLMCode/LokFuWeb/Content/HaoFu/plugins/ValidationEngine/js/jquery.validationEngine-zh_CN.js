	...
	$.validationEngineLanguage = {
		newLang:function(){
			$.validationEngineLanguage.allRules = {
				...
				"check": {
				    "url": "../asyn/check.html?time=" + new Date().getTime(),//ajax验证
				    "alertTextOk": "* 登录名可以使用。",
				    "alertTextLoad": "* 检查重复中, 请稍后...",
				    "alertText": "* 登录名重复，不可使用。",
				    "extraData": "extraData=SysAdmin"
				},
				"checkAdminUserName": {
				    "url": "../asyn/CheckAdminUserName.html",//ajax验证?time=" + new Date().getTime()
				    "alertTextOk": "* 该号码将成为登录名，请牢记。",
				    "alertTextLoad": "* 检查重复中, 请稍后...",
				    "alertText": "* 手机号码重复。",
				},
				"telephone": {
				    "regex": /^(\d{3,4}|\d{3,4}-)?\d{7,8}|(400|800)([0-9\\-]{7,10})$/,
...
$(function () {
    $('.chkForm').validationEngine({
        ...
        //"maxErrorsPerField": 1,
        //"addPromptClass": "validationEngineErrorContent", //提示框添加样式
        "scroll": false,
    });
});