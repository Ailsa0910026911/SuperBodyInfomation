...
{
    public class PangXieController : WeiXinBaseController
    {
        ...
        public PangXieController()
        {
            ...
            CutAct = Entity.CutAct.FirstOrNew(n => n.Id == 3);
            int cid = 0;
        ...
        public void Self()
        {
            ...
            Response.Redirect("/Mobile/PangXie/Index-" + CutUsers.Id + ".html");
        }
        public void ReSet()
        {
            if (!IsWeiXinBrowser)
