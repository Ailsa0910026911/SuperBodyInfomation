...
namespace LokFu.Areas.Agent.Controllers
{
    public class APPIconManagementController : BaseController
    {
        ...
        {
            if (APPModule.Id != 0) APPModule = Entity.APPModule.FirstOrDefault(n => n.Id == APPModule.Id && n.AgentId == BasicAgent.Id);
            if (APPModule == null)
            {
        ...
        {
            var baseAPPModule = Entity.APPModule.FirstOrDefault(n => n.Id == id && n.AgentId == BasicAgent.Id);
        ...
        public ActionResult Add(APPModule APPModule)
        {
            ...
            APPModule.Version = 1;
            APPModule.AgentId = BasicAgent.Id;
