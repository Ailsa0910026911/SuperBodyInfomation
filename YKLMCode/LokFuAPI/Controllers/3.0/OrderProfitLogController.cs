...
{
    public class OrderProfitLogController : InitController
    {
        ...
        public void Post()
        {
            ...
            if (!OrderProfitLog.Pg.IsNullOrEmpty()) { p.PageIndex = OrderProfitLog.Pg; }
            if (!OrderProfitLog.Pgs.IsNullOrEmpty()) { p.PageSize = OrderProfitLog.Pgs; }
